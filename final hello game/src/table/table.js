...
class Table extends Component {
    ...
    clearTable = ()=>{
        ...
        console.log("clear self function", this.clearSelf());
    }

    clearSelf = () => {
        if (this.state.clearSelf==true){
            return true
        }
        else return false;
    }
    ...
    componentDidMount(){
      ...
      this.props.socket.on("winner-1-noty",(data)=>{
        if (this.props.myid == data.myid || this.props.myid== data.oppId){
      ...
      this.props.socket.on("winner-2-noty",(data)=>{
        if (this.props.myid == data.myid || this.props.myid== data.oppId){
      ...
      this.props.socket.on("no-winner-noty",(data)=>{
        if (this.props.myid == data.myid || this.props.myid== data.oppId){
